...
import org.pixel.graphics.render.PxRenderEngine;
...
public class PixelRender2DTest {
    ...
    private void init() {
        ...
        renderEngine = new PxRenderEngine(new Rectangle(0, 0, SWIDTH, SHEIGHT));
    }
