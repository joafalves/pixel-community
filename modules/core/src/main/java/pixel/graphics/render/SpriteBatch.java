...
import pixel.content.FontGlyph;
import pixel.content.Texture;
import pixel.graphics.Color;
import pixel.graphics.shader.ShaderManager;
import pixel.graphics.shader.VertexArrayObject;
import pixel.graphics.shader.VertexBufferObject;
import pixel.graphics.shader.standard.TextureShader;
...
public class SpriteBatch extends DrawBatch {
    ...
    private void processSpriteData(SpriteData sprite) {
        ...
        if (sprite.source != null) {
            // use has defined custom source area; the input is relative to the real width and height of
